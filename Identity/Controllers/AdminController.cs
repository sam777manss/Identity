...
namespace Identity.Controllers
{
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> Create(User user)
        {
            ...
            ModelState.Remove("Hobbies_Football");
            ModelState.Remove("Hobbies_Dance");
            ModelState.Remove("Hobbies_Cricket");
            if (ModelState.IsValid)
            {
                AppUser appUser = new AppUser
                {
                    ...
                    Mobile = user.Mobile,
                    Gender = user.Gender,
                    Hobbies_Football = user.Hobbies_Football,
                    Hobbies_Cricket = user.Hobbies_Cricket,
                    Hobbies_Dance = user.Hobbies_Dance
